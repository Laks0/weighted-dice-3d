...
func onDieHit(_body):
	magnitude = die.linear_velocity.length() #en este momento magnitude va más o menos entre 0 y 8. Vamos a dividir en 8 para tener una suerte de normalización aproximada
